import { FaLock, FaEyeSlash, FaPhoneAlt } from "react-icons/fa";
const UserPage = () => {
              ...
              <div className="panel-body p-3">
                <form action="login_script.php" method="POST">
                  ...
                  <div className="form-group py-1 pb-2">
                    <div className="input-field">
                      ...
                      <button className="btn bg-white text-muted">
                        <span className="far"><FaEyeSlash/></span>
                      </button>
                    </div>
                  </div>
                  <div className="form-inline">
                    ...
                    <a to="#" id="forgot" className="font-weight-bold" style={{ color: "#0ed145"}}>
                      Mot de passe oublié?
                    </a>
                  </div>
                  <div className="btn btn-primary btn-block mt-3">Se connecter</div>
